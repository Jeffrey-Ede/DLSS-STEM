...
def experiment(feature, ground_truth, mask, learning_rate_ph, discr_lr_ph, beta1_ph, 
    ...
    mse0 = (blur_truth - output_outer)**2
...
def gen_lq(img0):
    ...
    use_frac = 1/np.random.randint(4, 11)**2
                ...
                while True:
                    ...
                    while time.time()-time0 < modelSavePeriod:
                        ...
                        if counter < max_count:
                            ...
                            mses /= counter + 1
                            np.save(model_dir+"mses-image.npy", mses)
