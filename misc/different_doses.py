...
parent = "Z:/Jeffrey-Ede/models/"
prependings = [
    "stem-random-walk-nin-20-65/test_output-", 
    "stem-random-walk-nin-20-54/test_output-", 
    "stem-random-walk-nin-20-63/test_output-", 
    "stem-random-walk-nin-20-64/test_output-"
    ]
...
f.savefig('different_doses-1.png', bbox_inches='tight')
