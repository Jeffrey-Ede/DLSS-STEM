...
model_dir = "//flexo.ads.warwick.ac.uk/Shared41/Microscopy/Jeffrey-Ede/models/stem-random-walk-nin-20-64/"
            ...
            with tf.Session(config=sess_config) as sess:
                ...
                while True:
                    ...
                    while time.time()-time0 < modelSavePeriod:
                        ...
                        message = "NiN-64, Iter: {}, MSE_in: {}, MSE: {}, Wass G: {}, Wass D: {}, Val: {}".format(
