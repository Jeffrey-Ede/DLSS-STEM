...
prependings = [f"final_49_output-18", f"final_49_output-18_deconv", f"final_49_output-33", f"final_49_output-33_deconv"]
...
for i in image_nums:
    for prepending in prependings:
        filename = parent + prepending + f".tif"
...
scale = 4
width = scale * 2.2
height = 1.1*scale* (width / 1.618) / 2.2 / 5.1
...
f.subplots_adjust(wspace=-0.00, hspace=0.8)
...
f.savefig(f'deconv_panel.png', bbox_inches='tight')
