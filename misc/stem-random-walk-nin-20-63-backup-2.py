...
model_dir = "//flexo.ads.warwick.ac.uk/Shared41/Microscopy/Jeffrey-Ede/models/stem-random-walk-nin-20-63/"
    ...
    with open(log_file, 'a') as log:
        ...
        with tf.control_dependencies(update_ops):
            ...
            with tf.Session(config=sess_config) as sess:
                ...
                counter = 686_085#436_810#375_198
                val_counter = 0
                ...
                while True:
                    ...
                    while time.time()-time0 < modelSavePeriod:
                        ...
                        message = "NiN-63, Iter: {}, MSE_in: {}, MSE: {}, Wass G: {}, Wass D: {}, Val: {}".format(
